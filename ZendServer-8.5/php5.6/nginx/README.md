...
To build run:
```
docker build -t janatzend/zend-server:8.5-php5.6-nginx .
```
...
```
docker run -d -p 88:80 -p 10088:10081 janatzend/zend-server:8.5-php5.6-nginx
```
...
```
docker run -d janatzend/zend-server:8.5-php5.6-nginx
```
or
```
docker run janatzend/zend-server:8.5-php5.6-nginx
```
